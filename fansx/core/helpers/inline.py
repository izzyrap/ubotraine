...
class BTN:
    ...
    def PROMODEK(message):
        button = [
            [InlineKeyboardButton("「 ✅ Setuju & Lanjutkan 」", url="http://t.me/RaineCute?text=Bang+Mau+Beli+Reseller+Ubot+Kirim+Qris+Atau+Dana")],
        ]
        return button

    def ALWAYSBOYSZ(message):
        button = [
            [InlineKeyboardButton("room public", url="https://t.me/izzyraproom")],
        ]
        return button
    ...
    def START(message):
        if not message.from_user.id == OWNER_ID:
            button = [
                ...
                [
                    InlineKeyboardButton("✭ ʀᴏᴏᴍ ᴘᴜʙʟɪᴄ ✭", url="https://t.me/izzyraproom"),
                    InlineKeyboardButton("⦪ owner ✭", url="https://t.me/RaineCute")
                ],
                [
                    InlineKeyboardButton("⦪ ᴀʙᴏᴜᴛ ᴋɪᴇʟ ✭", url="https://t.me/testirainecute")
                ],
                [
            ...
            button = [
                ...
                [
                    InlineKeyboardButton("⦪ ɢɪᴛᴘᴜʟʟ (ᴍᴀᴛɪɪɴ ᴜʙᴏᴛ) ⦫", callback_data="cb_gitpull"),
