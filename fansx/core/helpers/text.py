...
RAINE USERBOT
<b> 📚💎@{bot.me.username} Adalah bot yang dapat membuat userbot dengan efisien dan cepat. Bot ini dikembangkan oleh <a href=tg://openmessage?user_id={OWNER_ID}>@RaineCute</a> jika ada kendala atau kesalahan pada bot bisa dm owner bot nya</b></blockquote>
"""
...
"""
    ...
    async def UBOT(count):
        return f"""
<blockquote><b>╭〢ekik-userbot</b> <code>{int(count) + 1}/{len(ubot._ubot)}</code>
...
"""
    ...
    def POLICY():
        return """ <blockquote><b>ᴊɪᴋᴀ ᴀᴅᴀ ᴋᴇɴᴅᴀʟᴀ sɪʟᴀʜᴋᴀɴ ʜᴜʙᴜɴɢɪ  <a href=tg://openmessage?user_id={OWNER_ID}>@RaineCute</a></b></blockquote>
"""
